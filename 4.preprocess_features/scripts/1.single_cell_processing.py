...
for plate, info in plate_info_dictionary.items():
    ...
    column_name_mapping = {
        ...
        "Image_Count_Nuclei": "Metadata_Nuclei_Count",
        "Nuclei_Number_Object_Number": "Metadata_ObjectNumber_Nuclei"
    }
...
# Check output file
test_df = pd.read_parquet("./data/single_cell_profiles/slide2_sc_annotated.parquet")
